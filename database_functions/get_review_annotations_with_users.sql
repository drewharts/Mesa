-- ============================================================================
-- Function: get_review_annotations_with_users
-- ============================================================================
-- Returns map annotations for reviewed places with grid-based clustering
...
CREATE OR REPLACE FUNCTION public.get_review_annotations_with_users(
    p_user_id text,
...
BEGIN
    ...
    RETURN QUERY
    WITH review_annotations AS (
        SELECT DISTINCT ON (r.place_id)
            r.place_id::text AS id,
            p.name,
