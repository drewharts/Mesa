//
//  ReviewsPopupPlaceCard.swift
//  loc
//
//  Single Responsibility: Display a reviewed place card with tap interactions
//  MVVM: All business logic delegated to ViewModels
//  Structure: Matches TikTokPopupPlaceCard for consistent styling

import SwiftUI

struct ReviewsPopupPlaceCard: View {
