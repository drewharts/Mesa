//
//  CommunityPlaceGridCell.swift
//  loc
//
//  Dumb Component: Displays a community place in the grid.
//  
//  Single Responsibility: Render community place data as a grid cell
...
struct CommunityPlaceGridCell: View {
