...
struct GoogleMapsImportView: View {
    ...
    /// Optional close callback for contexts where dismiss() doesn't work (e.g. ZStack overlays).
    ...
    /// Dismisses the import view, preferring the onClose callback if provided.
